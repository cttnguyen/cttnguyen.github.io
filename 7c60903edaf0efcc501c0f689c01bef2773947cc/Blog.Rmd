...
What the heck is a proposal card? Just a little greeting card, sent in the mail or in person, to "propose" that a person be in your wedding party. Basically, one of those Hallmark industry made up things, but it's pretty hard for me to turn down a DIY opportunity.We went through a few drafts to get the process down as well as the aesthetic/vibe we were going for. For example, we had a standard card designed for our entire crew. We ultimately decided against it so we would have space to write in personal notes.

A final note before getting started: just make your own envelopes next time. I hear a lot of brides have a small, final straw in the stress of wedding planning: envelopes was mine. After making these cards at the industry standard size, I realized I could not find envelopes at the appropriate size in a small amount. Envelopes. Plain. Not in a envelope+card pack. I had to buy 100 or spend $15 on a handful. I had a meltdown - not my finest moment. BUT then I discovered I could make my own envelopes. If you've got a Cricut (or scissors and a lot of time?) this is so worth it for custom envelopes (think of all the cardstock options). 

Supplies:

* Cardstock, medium to heavy weight will "feel" better
* Adhesive Foil
